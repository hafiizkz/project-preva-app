...
class PostModel {
  final String id, userId, userName, userRole, userProfilePic, title, category, subCategory, condition, description, locationName, latitude, longitude, imageUrl;
  final DateTime timestamp;
  final List<String> favorites;

  PostModel({
    required this.id, required this.userId, required this.userName, required this.userRole, 
    required this.userProfilePic, // Tambahkan ini
  ...
  Map<String, dynamic> toMap() => {
    ...
    "userName": userName, 
    "userRole": userRole, 
    "userProfilePic": userProfilePic, // Tambahkan ini
    "title": title, 
    "category": category, 
  ...
  factory PostModel.fromMap(Map<String, dynamic> map, String id) => PostModel(
    ...
    userProfilePic: map['userProfilePic'] ?? '', // Tambahkan ini
    title: map['title'] ?? '', 
